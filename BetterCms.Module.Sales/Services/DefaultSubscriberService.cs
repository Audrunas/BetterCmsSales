...
//using BetterCms.Module.Sales.Exceptions;
...
//        /// Saved entity
//        /// </returns>
//        public Supplier SaveSubscriber(string email, Guid id, int version, bool ignoreUniqueSubscriberException = false)
//        {
...
//            if (isNew)
//            {
//                subscriber = new Supplier();
//            }
//            else
//            {
//                subscriber = repository.AsQueryable<Supplier>(w => w.Id == id).FirstOne();
//            }
//
...
//        public Supplier SaveSubscriber(string email)
//        {
...
//        /// <returns></returns>
//        private bool ValidateSubscriber(Guid id, string email, out Supplier subscriber)
//        {
//            var query = repository.AsQueryable<Supplier>(s => s.Email == email);
